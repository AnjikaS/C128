...
# Webdriver
browser = webdriver.Chrome("/Users/ravishankar/Desktop/chromedriver")
browser.get(Start_url)
time.sleep(10)

Planets_data = []
headers = ["name","light_years_from_earth","planet_masses","stellar_magnitude","discovery_date","hyperlink",
